                ...
                <form className="w-full" action="https://api.web3forms.com/submit" method="POST">
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div className="w-full md:w-1/2 px-3">
                            ...
                            <input className="appearance-none bg-transparent border-b border-trueGray-200 w-full text-gray-50 mr-3 p-4 leading-tight focus:outline-none focus:bg-trueGray-800" type="text" name="Last Name" placeholder="Doe" requried/>
                        </div>
                    </div>
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                            ...
                            <input className="appearance-none bg-transparent border-b border-trueGray-200 w-full text-gray-50 mr-3 p-4 leading-tight focus:outline-none focus:bg-trueGray-800" type="email" name="Email" placeholder="janedoe@youremail.com" requried/>
                        </div>
                    </div>
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                            ...
                            <textarea rows="10" className="appearance-none bg-transparent border-b border-trueGray-200 w-full text-gray-50 mr-3 p-4 focus:bg-trueGray-800 leading-tight focus:outline-none" type="message" name="Message" placeholder="Looking forward to hearing from you!" requried>
