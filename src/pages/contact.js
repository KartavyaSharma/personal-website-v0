        ...
        <div className='bg-trueGray-900'>
            ...
            <div className="p-5 px-6 md:px-8 lg:px-12 xl:px-20 2xl:px-36 max-w-screen-2xl w-full mx-auto font-mono">
                <div className="text-center mb-16">
                    ...
                    <h3 className="text-4xl leading-normal font-extrabold tracking-tight text-gray-100">
                ...
                <form className="w-full" action="https://api.web3forms.com/submit" method="POST">
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input className="appearance-none bg-transparent border-b border-red-500 w-full text-gray-50 mr-3 p-4 leading-tight focus:outline-none focus:bg-trueGray-800" type="text" name="First Name" placeholder="Jane" requried />
                        ...
                        <div className="w-full md:w-1/2 px-3">
                            ...
                            <input className="appearance-none bg-transparent border-b border-orange-500 w-full text-gray-50 mr-3 p-4 leading-tight focus:outline-none focus:bg-trueGray-800" type="text" name="Last Name" placeholder="Doe" requried/>
                        </div>
                    </div>
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                            ...
                            <input className="appearance-none bg-transparent border-b border-orange-500 w-full text-gray-50 mr-3 p-4 leading-tight focus:outline-none focus:bg-trueGray-800" type="email" name="Email" placeholder="janedoe@youremail.com" requried/>
                        </div>
                    </div>
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                            ...
                            <textarea rows="10" className="appearance-none bg-transparent border-b border-orange-500 w-full text-gray-50 mr-3 p-4 focus:bg-trueGray-800 leading-tight focus:outline-none" type="message" name="Message" placeholder="Looking forward to hearing from you!" requried>
