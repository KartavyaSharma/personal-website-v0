            ...
            <div className='z-10 relative' data-sal="fade" data-sal-easing="ease" data-sal-duration="1500">
                ...
                <div className='flex flex-row 2xl:py-8'>
                    <div className='flex flex-row text-2xl'>
                        ...
                        <a className='pl-3 text-gray-100 hover:underline' href='https://github.com/KartavyaSharma' target="_blank" rel="noreferrer">Github</a>
                    </div>
                    ...
                    <div className='pl-5 flex flex-row text-2xl'>
                        ...
                        <a className='pl-3 text-gray-100 hover:underline' href='https://www.linkedin.com/in/kartavya-sharma/' target="_blank" rel="noreferrer">Linkedin</a>
                    </div>
