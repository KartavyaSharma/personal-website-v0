    ...
    return (
        <div 
            ...
            <div data-sal="slide-right" data-sal-easing="ease" data-sal-duration="1000">
                <div className='text-lg sm:text-xl md:text-2xl lg:text-4xl font-semibold font-mono bg-clip-text text-orange-500'>{idx}</div>
                <div className='text-5xl md:text-5xl lg:text-8xl font-bold font-mono text-white'>{name}</div>
            </div>
            {children}
        </div>
    );
