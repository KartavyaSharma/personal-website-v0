...
function intro(props) {
    return (
        <div className={props.header}>
            ...
            <br />
            <nav className='justify-between items-center relative font-semibold text-2xl bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-500' role='navigation'>
            ...
            <div className='text-white text-xl lg:text-3xl py-8 md:py-12 lg:py-16'>
                ...
                Web Development Technologies, and Machine Learning. I currently dabble in C++ and Python, but am currently exploring Jamstack with React (Gatsby,)
                GraphQL, and headless CMS services.
            </div>
            <div className='flex flex-row py-8 md:py-12 lg:py-16'>
                <div className='flex flex-row text-2xl'>
                    ...
                    <a className='pl-3 text-gray-100' href='https://github.com/KartavyaSharma' target="_blank">Github</a>
                </div>
                <div className='pl-5 text-white font-bold'>.</div>
                <div className='pl-5 flex flex-row text-2xl'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="white" class="bi bi-envelope-fill" viewBox="0 0 16 16">
                        <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555zM0 4.697v7.104l5.803-3.558L0 4.697zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757zm3.436-.586L16 11.801V4.697l-5.803 3.546z" />
                    </svg>
                    <a className='pl-3 text-gray-100' href='mailto:kartavya@berkeley.edu'>Email</a>
                </div>
                <div className='pl-5 text-white font-bold'>.</div>
                <div className='pl-5 flex flex-row text-2xl'>
                    ...
                    <a className='pl-3 text-gray-100' href='https://www.linkedin.com/in/kartavya-sharma/'>Linkedin</a>
                </div>
            </div>
        </div>
    )
