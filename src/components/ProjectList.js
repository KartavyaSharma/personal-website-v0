                                    ...
                                    <div>
                                        <div className="mx-auto flex px-5  md:flex-row flex-col items-center jobcard">
                                            ...
                                            <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 sm:block hidden">
                                                {/* <img className="object-cover object-center rounded" alt="hero" src={project.node.img} /> */}
                                                <Img src={project.node.img.childImageSharp.fluid.src} fluid={project.node.img.childImageSharp.fluid} alt={project.node.alt} className='object-cover object-center rounded'/>
                                            </div>
                                        </div>
                                    </div>
                                </section>
