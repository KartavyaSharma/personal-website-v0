                                                ...
                                                <figure className="visible">
                                                    <div className="">
                                                        <div className="pt-10 px-2 sm:px-6">
                                                            ...
                                                            <div className="text-orange-50 text-xs sm:text-sm md:text-base pb-6">From local banks to local government, we partner with organizations on their journey to digital transformation. Our customers include 15 million professionals in 175 countries and 800 of the fortune 1000.</div>
                                                            <div className="text-orange-50 text-xs sm:text-sm md:text-base pb-8">We can't believe how far we have come in the last 6 months. I really did not think this awesome career move would come so quickly. Thanks to each of you put into SI and the partner relationships.</div>
