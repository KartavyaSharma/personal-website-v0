            ...
            <div className="h-1/2 overflow-hidden flex items-center justify-center">
                <div className="w-full flex items-center justify-center">
                    <div className="w-full px-6 md:px-8 lg:px-12 xl:px-20 2xl:px-36 mx-auto max-w-screen-2xl text-white flex flex-col">
                        <div className="w-full text-2xl md:text-3xl lg:text-6xl font-bold" data-sal="slide-right" data-sal-easing="ease" data-sal-duration="1000">
                        ...
                        <div className="flex sm:mt-2 md:mt-4 lg:mt-8 flex-col md:flex-row md:justify-between">
                            <div className="w-full md:w-2/3 text-gray-400" data-sal="slide-right" data-sal-easing="ease" data-sal-duration="1000">I am currently involved with freelance web development for small to medium projects and am always interested in a challenge. Let's connect!</div>
                            <div className="w-44 pt-6 md:pt-0">
                                <a href='/contact/' className="bg-orange-500 hover:bg-orange-600 rounded-lg justify-center text-center shadow px-10 py-3 flex items-center"
