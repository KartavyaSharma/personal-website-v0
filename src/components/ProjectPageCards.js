...
export default function ProjectPageCards({ cardData }) {
    ...
    function renderCardList() {
        return (
            <div
                className={`grid grid-cols-1 w-full grid-rows-${data.length} gap-y-5`}
            >
                {data.map(project => {
                    return (
                        <Link
                            to={`/project/${project.node.name
                                ...
                                .toLowerCase()}`}
                        >
                            <div className="w-full border border-trueGray-800 rounded grid grid-rows-2 p-4">
                                <div>
    ...
    return (
        <div className="w-full flex flex-row justify-end sticky top-10 2xl:top-20">
