            ...
            <div data-sal="slide-right" data-sal-easing="ease" data-sal-duration="1000">
                ...
                <div className='flex flex-col'>
                    <div className='flex md:flex-row md:items-center flex-col items-start'>
                        ...
                        <div className='font-semibold text-white text-sm md:text-2xl lg:text-3xl pt-3 md:pt-0 md:pl-5 flex'><span className='hidden md:block pr-2'>|</span> Latest Posts</div>
                    </div>
                </div>
            </div>
