                    ...
                    <div className='flex flex-row items-center pt-14'>
                        {
                            queryData.projectlink !== "" ? (
                                <a href={`${queryData.projectlink}`} target="_blank">
                                    <button className='py-2 px-4 mr-3 text-white rounded border border-white border-opacity-50 hover:border-orange-500 hover:bg-trueGray-800 flex'>
                        ...
                        }
                        {
                            true && queryData.githubLink !== "" ? (
                                <a href={`${queryData.githublink}`} target="_blank">
                                    <button className='py-2 px-4 text-white rounded border border-white border-opacity-50 hover:border-orange-500 hover:bg-trueGray-800 flex justify-center items-center'>
