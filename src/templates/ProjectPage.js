        ...
        <div className='bg-trueGray-900'>
            ...
            <div className="pt-14 lg:pt-16 lg:pb-24 px-6 md:px-8 lg:px-12 xl:px-20 2xl:px-36 mb-16 lg:mb-4 max-w-screen-2xl w-full mx-auto flex" data-sal="fade" data-sal-easing="ease" data-sal-duration="1500">
                <div className='max-w-4xl flex flex-col justify-center'>
                    ...
                    <div className='text-3xl text-white font-mono font-semibold mt-10'>Project details</div>
                    <p className='text-white font-blogBody pt-5'>{queryData.about}</p>
                    <div className='text-3xl text-white font-mono font-semibold mt-5'>Technology stack and API usage</div>
                    <div className='text-3xl text-white font-mono font-semibold mt-5'>My experience</div>
                </div>
            </div>
            <Footer isPage={true} />
        </div>
